...
public class BestellingTest {
    ...
    public void getBezorgKosten(){
        assertEquals(8.50, bestel.getBezorgKosten(1, true, 20, true), 0.001);
        assertEquals(0.00, bestel.getBezorgKosten(1, false, 30, false), 0.001);
        assertEquals(7.50, bestel.getBezorgKosten(10, true, 30, true), 0.001);
        assertEquals(0.00, bestel.getBezorgKosten(10, false, 20, false), 0.001);
        assertEquals(6.00, bestel.getBezorgKosten(17, true, 30, true), 0.001);
        assertEquals(0.00, bestel.getBezorgKosten(17, false, 20, false), 0.001);
    }
} 